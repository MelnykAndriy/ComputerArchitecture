...
class TestXml(unittest.TestCase):
    ...
    def testReadValidXml(self):
        self.assertEqual(len(parse_urls_xml("test1_1.xml")), 2, 'Checks correct reading of xml file.')
        self.assertEqual(parse_urls_xml("test1_1.xml"),
                         ['https://pypi.python.org/pypi/pip/#downloads', 'http://docs.python-guide.org/'],
